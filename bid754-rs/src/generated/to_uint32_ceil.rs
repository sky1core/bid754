// Auto-generated from to_uint32_ceil.go by go2rs. Do not edit.

use super::prelude::*;

pub fn bid64_to_uint32_ceil(mut x: u64) -> (u32, u32) {
    let mut res: u32 = 0;
    ...
    if (((q.wrapping_add(exp))) > 10) {
        ...
        if (x_sign != 0) {
            ...
            if (q <= 11) {
                ...
                tmp64 = ((0x9fffffff6 as u64).wrapping_mul(bid_ten2k64[(q.wrapping_sub(11)) as usize]));
                if (C1 > tmp64) {
                    pfpsf |= 1;
                    res = 0x80000000;
                    return (res, pfpsf);
...
pub fn bid64_to_uint32_xceil(mut x: u64) -> (u32, u32) {
    let mut res: u32 = 0;
    let mut x_sign: u64 = 0;
    let mut x_exp: u64 = 0;
    let mut exp: i64 = 0;
