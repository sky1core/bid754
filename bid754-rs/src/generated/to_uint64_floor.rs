// Auto-generated from to_uint64_floor.go by go2rs. Do not edit.

use super::prelude::*;

pub fn bid64_to_uint64_floor(mut x: u64) -> (u64, u32) {
    let mut res: u64 = 0;
...
pub fn bid64_to_uint64_xfloor(mut x: u64) -> (u64, u32) {
    let mut res: u64 = 0;
    let mut x_sign: u64 = 0;
    let mut x_exp: u64 = 0;
    let mut exp: i64 = 0;
