// Code generated by go2rs from bid128_next.go; DO NOT EDIT.

// Mechanical Go/C-shaped port of bid754-go/internal/bidgo/bid128_next.go; the style/shape
...
pub fn bid128_next_up(mut x: BID_UINT128) -> (BID_UINT128, u32) {
    ...
    if ((C1.hi == 0x0) && (C1.lo == 0x0)) {
        ...
        if ((x.hi == 0x5fffed09bead87c0) && (x.lo == 0x378d8e63ffffffff)) {
            res.hi = 0x7800000000000000;
            res.lo = 0x0000000000000000;
        } else if ((x.hi == 0x8000000000000000) && (x.lo == 0x0000000000000001)) {
            res.hi = 0x8000000000000000;
            res.lo = 0x0000000000000000;
        } else {
            if (C1.hi == 0) {
                if (C1.lo >= 0x0020000000000000) {
                    if (C1.lo >= 0x0000000100000000) {
            ...
            if (q1 < 34) {
                ...
                if ((exp.wrapping_add(6176)) > ((34 as i64).wrapping_sub(q1))) {
                    ...
                    if (q1 <= 19) {
                        if (ind <= 19) {
                            C1 = __mul_64x64_to_128(C1.lo, bid_ten2k64[ind as usize]);
                        } else {
                            C1 = __mul_128x64_to_128(C1.lo, bid_ten2k128[(ind.wrapping_sub(20)) as usize]);
                        }
                    } else {
                        if (ind <= 14) {
            ...
            if (x_sign == 0) {
                ...
                C1.lo = C1.lo.wrapping_sub(1);
                if (C1.lo == 0xffffffffffffffff) {
                    C1.hi = C1.hi.wrapping_sub(1);
                }
                if (((x_exp != 0) && (C1.hi == 0x0000314dc6448d93)) && (C1.lo == 0x38c15b09ffffffff)) {
...
pub fn bid128_next_down(mut x: BID_UINT128) -> (BID_UINT128, u32) {
    ...
    if ((C1.hi == 0x0) && (C1.lo == 0x0)) {
        ...
        if ((x.hi == 0xdfffed09bead87c0) && (x.lo == 0x378d8e63ffffffff)) {
            res.hi = 0xf800000000000000;
            res.lo = 0x0000000000000000;
        } else if ((x.hi == 0x0) && (x.lo == 0x0000000000000001)) {
            res.hi = 0x0000000000000000;
            res.lo = 0x0000000000000000;
        } else {
            if (C1.hi == 0) {
...
pub fn bid128_next_after(mut x: BID_UINT128, mut y: BID_UINT128) -> (BID_UINT128, u32) {
    ...
    let mut tmp3: BID_UINT128 = BID_UINT128 { lo: 0, hi: 0 };
    ...
    if ((x.hi & 0x7c00000000000000) != 0x7800000000000000) {
        if ((x.hi & 0x6000000000000000) == 0x6000000000000000) {
            x_exp = (((go_checked_shl_u64(x.hi, go_shift_count_u64((2) as u64)))) & 0x7ffe000000000000);
            x.hi = ((x.hi & 0x8000000000000000) | x_exp);
            x.lo = 0x0;
        } else {
            x_exp = (x.hi & 0x7ffe000000000000);
    ...
    pfpsf = tmp_fpsf;
    if (res1 != 0) {
        res.hi = ((x.hi & 0x7fffffffffffffff) | (y.hi & 0x8000000000000000));
        res.lo = x.lo;
    } else if (res2 != 0) {
    ...
    if ((((x.hi & 0x7800000000000000) != 0x7800000000000000)) && (((res.hi & 0x7800000000000000) == 0x7800000000000000))) {
        pfpsf |= 32;
        pfpsf |= 8;
    }
    tmp1.hi = 0x0000314dc6448d93;
    tmp1.lo = 0x38c15b0a00000000;
