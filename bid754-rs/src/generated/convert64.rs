// Code generated by go2rs from convert64.go; DO NOT EDIT.

// Mechanical Go/C-shaped port of bid754-go/internal/bidgo/convert64.go; the style/shape
...
pub(crate) fn bid_round128_19_38_for64(mut q: i64, mut x: i64, mut C: u64, incr_exp: &mut i64, is_midpoint_lt_even: &mut i64, is_midpoint_gt_even: &mut i64, is_inexact_lt_midpoint: &mut i64, is_inexact_gt_midpoint: &mut i64) -> u64 {
    ...
    Cstar.lo = (((go_checked_shr_u64(P256.w2, go_shift_count_i64((shift) as i64)))) | ((go_checked_shl_u64(P256.w3, go_shift_count_i64(((((64 as i64).wrapping_sub(shift)))) as i64)))));
    Cstar.hi = (go_checked_shr_u64(P256.w3, go_shift_count_i64((shift) as i64)));
    fstar.w0 = P256.w0;
    fstar.w1 = P256.w1;
    fstar.w2 = (P256.w2 & bid_mask128_for64[ind as usize]);
    fstar.w3 = 0;
    if ((fstar.w2 > bid_half128_for64[ind as usize]) || (((fstar.w2 == bid_half128_for64[ind as usize]) && (((fstar.w1 != 0) || (fstar.w0 != 0)))))) {
        tmp64 = (fstar.w2.wrapping_sub(bid_half128_for64[ind as usize]));
        if (((tmp64 != 0) || (fstar.w1 > bid_ten2mxtrunc128_for64[ind as usize].hi)) || (((fstar.w1 == bid_ten2mxtrunc128_for64[ind as usize].hi) && (fstar.w0 > bid_ten2mxtrunc128_for64[ind as usize].lo)))) {
            (*is_inexact_lt_midpoint) = 1;
        }
    } else {
        (*is_inexact_gt_midpoint) = 1;
    }
    if (((fstar.w3 == 0) && (fstar.w2 == 0)) && (((fstar.w1 < bid_ten2mxtrunc128_for64[ind as usize].hi) || (((fstar.w1 == bid_ten2mxtrunc128_for64[ind as usize].hi) && (fstar.w0 <= bid_ten2mxtrunc128_for64[ind as usize].lo)))))) {
        if ((Cstar.lo & 0x01) != 0) {
