// Code generated by go2rs from to_int32_ceil.go; DO NOT EDIT.

// Mechanical Go/C-shaped port of bid754-go/internal/bidgo/to_int32_ceil.go; the style/shape
    ...
    if (((q.wrapping_add(exp))) <= 0) {
        ...
        if (exp < 0) {
            ...
            if (((ind.wrapping_sub(1))) <= 2) {
                if (fstar.lo > bid_ten2mk128trunc[(ind.wrapping_sub(1)) as usize].hi) {
                    if (x_sign == 0) {
                        Cstar = Cstar.wrapping_add(1);
                    }
                }
            } else {
                if ((fstar.hi != 0) || (fstar.lo > bid_ten2mk128trunc[(ind.wrapping_sub(1)) as usize].hi)) {
                    if (x_sign == 0) {
                        Cstar = Cstar.wrapping_add(1);
                    }
                }
