// Code generated by go2rs from rem64.go; DO NOT EDIT.

// Mechanical Go/C-shaped port of bid754-go/internal/bidgo/rem64.go; the style/shape
...
pub fn bid64_rem(mut x: u64, mut y: u64) -> (u64, u32) {
    ...
    if (diff_expon <= 0) {
        ...
        if ((CY.hi != 0) || (CY.lo > ((go_checked_shl_u64(coefficient_x, go_shift_count_u64((1) as u64)))))) {
            res = x;
            return (res, pfpsf);
        }
