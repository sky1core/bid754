// Auto-generated from bid128_round_integral.go by go2rs. Do not edit.

use super::prelude::*;

pub fn bid128_round_integral_exact(mut x: BID_UINT128, mut rnd_mode: i64, pfpsf: &mut u32) -> BID_UINT128 {
    ...
    if (C1.w[1] == 0) {
        if (C1.w[0] >= 0x0020000000000000) {
            ...
            x_nr_bits = ((33 as u32).wrapping_add(((((((go_checked_shr_u64(tmp1, go_shift_count_u64((52) as u64)))) & 0x7ff)).wrapping_sub(0x3ff)) as u32)));
        } else {
            let mut tmp1 = (C1.w[0] as f64).to_bits();
            x_nr_bits = ((1 as u32).wrapping_add(((((((go_checked_shr_u64(tmp1, go_shift_count_u64((52) as u64)))) & 0x7ff)).wrapping_sub(0x3ff)) as u32)));
        }
    } else {
        let mut tmp1 = (C1.w[1] as f64).to_bits();
        x_nr_bits = ((65 as u32).wrapping_add(((((((go_checked_shr_u64(tmp1, go_shift_count_u64((52) as u64)))) & 0x7ff)).wrapping_sub(0x3ff)) as u32)));
    }
            ...
            if (((q.wrapping_add(exp))) >= 0) {
                ...
                if ((ind.wrapping_sub(1)) <= 2) {
                    ...
                    if ((fstar.w[1] > 0x8000000000000000) || (((fstar.w[1] == 0x8000000000000000) && (fstar.w[0] > 0x0)))) {
                        ...
                        if ((tmp64 > bid_ten2mk128[(ind.wrapping_sub(1)) as usize].w[1]) || (((tmp64 == bid_ten2mk128[(ind.wrapping_sub(1)) as usize].w[1]) && (fstar.w[0] >= bid_ten2mk128[(ind.wrapping_sub(1)) as usize].w[0])))) {
                            (*pfpsf) |= 32;
                        }
                    } else {
                        (*pfpsf) |= 32;
                    ...
                    if ((fstar.w[2] > bid_onehalf128[(ind.wrapping_sub(1)) as usize]) || (((fstar.w[2] == bid_onehalf128[(ind.wrapping_sub(1)) as usize]) && (((fstar.w[1] != 0) || (fstar.w[0] != 0)))))) {
                        tmp64 = (fstar.w[2].wrapping_sub(bid_onehalf128[(ind.wrapping_sub(1)) as usize]));
                        if (((tmp64 != 0) || (fstar.w[1] > bid_ten2mk128[(ind.wrapping_sub(1)) as usize].w[1])) || (((fstar.w[1] == bid_ten2mk128[(ind.wrapping_sub(1)) as usize].w[1]) && (fstar.w[0] >= bid_ten2mk128[(ind.wrapping_sub(1)) as usize].w[0])))) {
                            (*pfpsf) |= 32;
                        }
                    } else {
                        (*pfpsf) |= 32;
                    ...
                    if ((fstar.w[3] > bid_onehalf128[(ind.wrapping_sub(1)) as usize]) || (((fstar.w[3] == bid_onehalf128[(ind.wrapping_sub(1)) as usize]) && ((((fstar.w[2] != 0) || (fstar.w[1] != 0)) || (fstar.w[0] != 0)))))) {
                        ...
                        if ((((tmp64 != 0) || (fstar.w[2] != 0)) || (fstar.w[1] > bid_ten2mk128[(ind.wrapping_sub(1)) as usize].w[1])) || (((fstar.w[1] == bid_ten2mk128[(ind.wrapping_sub(1)) as usize].w[1]) && (fstar.w[0] >= bid_ten2mk128[(ind.wrapping_sub(1)) as usize].w[0])))) {
                            (*pfpsf) |= 32;
                        }
                    } else {
                        (*pfpsf) |= 32;
...
pub(crate) fn bid128_round_integral_nornd_common(mut x: BID_UINT128, pfpsf: &mut u32) -> (BID_UINT128, bool, u64, u64, BID_UINT128, i64, i64) {
    let mut res: BID_UINT128 = BID_UINT128 { w: [0, 0] };
...
pub fn bid128_round_integral_nearest_even(mut x: BID_UINT128, pfpsf: &mut u32) -> BID_UINT128 {
    let mut res: BID_UINT128 = BID_UINT128 { w: [0, 0] };
    let mut fstar: BID_UINT256 = BID_UINT256 { w: [0, 0, 0, 0] };
    let mut P256: BID_UINT256 = BID_UINT256 { w: [0, 0, 0, 0] };
    let (mut res, mut done, mut x_sign, _, mut C1, mut q, mut exp) = bid128_round_integral_nornd_common(x, pfpsf);
    if done {
        return res;
    }
    if ((x.w[1] & 0x7ffe000000000000) <= 0x2ffa000000000000) {
        res.w[1] = (x_sign | 0x3040000000000000);
        res.w[0] = 0x0000000000000000;
        return res;
    }
    if (exp >= 0) {
        ...
        if ((ind.wrapping_sub(1)) <= 2) {
            res.w[1] = P256.w[3];
            res.w[0] = P256.w[2];
            if (((res.w[0] & 0x0000000000000001) != 0) && ((((P256.w[1] < (bid_ten2mk128[(ind.wrapping_sub(1)) as usize].w[1]))) || ((((P256.w[1] == bid_ten2mk128[(ind.wrapping_sub(1)) as usize].w[1])) && ((P256.w[0] < bid_ten2mk128[(ind.wrapping_sub(1)) as usize].w[0]))))))) {
                res.w[0] = res.w[0].wrapping_sub(1);
            }
        } else if ((ind.wrapping_sub(1)) <= 21) {
            ...
            let mut shift = ((bid_shiftright128[(ind.wrapping_sub(1)) as usize] as i64).wrapping_sub(64));
            res.w[1] = 0;
            res.w[0] = (go_checked_shr_u64(P256.w[3], go_shift_count_u64((shift as u64) as u64)));
            fstar.w[3] = (P256.w[3] & bid_maskhigh128[(ind.wrapping_sub(1)) as usize]);
            fstar.w[2] = P256.w[2];
...
pub fn bid128_round_integral_negative(mut x: BID_UINT128, pfpsf: &mut u32) -> BID_UINT128 {
    let mut res: BID_UINT128 = BID_UINT128 { w: [0, 0] };
    let mut fstar: BID_UINT256 = BID_UINT256 { w: [0, 0, 0, 0] };
    let mut P256: BID_UINT256 = BID_UINT256 { w: [0, 0, 0, 0] };
    let (mut res, mut done, mut x_sign, mut x_exp, mut C1, mut q, mut exp) = bid128_round_integral_nornd_common(x, pfpsf);
    if done {
        return res;
    }
    if (x_exp <= 0x2ffc000000000000) {
...
pub fn bid128_round_integral_positive(mut x: BID_UINT128, pfpsf: &mut u32) -> BID_UINT128 {
    let mut res: BID_UINT128 = BID_UINT128 { w: [0, 0] };
    let mut fstar: BID_UINT256 = BID_UINT256 { w: [0, 0, 0, 0] };
    let mut P256: BID_UINT256 = BID_UINT256 { w: [0, 0, 0, 0] };
    let (mut res, mut done, mut x_sign, mut x_exp, mut C1, mut q, mut exp) = bid128_round_integral_nornd_common(x, pfpsf);
...
pub fn bid128_round_integral_zero(mut x: BID_UINT128, pfpsf: &mut u32) -> BID_UINT128 {
    let mut res: BID_UINT128 = BID_UINT128 { w: [0, 0] };
    let mut P256: BID_UINT256 = BID_UINT256 { w: [0, 0, 0, 0] };
    let (mut res, mut done, mut x_sign, mut x_exp, mut C1, mut q, mut exp) = bid128_round_integral_nornd_common(x, pfpsf);
    if done {
...
pub fn bid128_round_integral_nearest_away(mut x: BID_UINT128, pfpsf: &mut u32) -> BID_UINT128 {
    let mut res: BID_UINT128 = BID_UINT128 { w: [0, 0] };
    let mut P256: BID_UINT256 = BID_UINT256 { w: [0, 0, 0, 0] };
    let (mut res, mut done, mut x_sign, _, mut C1, mut q, mut exp) = bid128_round_integral_nornd_common(x, pfpsf);
    if done {
    ...
    if (exp >= 0) {
        ...
        if ((ind.wrapping_sub(1)) <= 2) {
            ...
            let mut shift = (bid_shiftright128[(ind.wrapping_sub(1)) as usize] as i64);
            res.w[1] = 0;
            res.w[0] = ((go_checked_shr_u64(P256.w[3], go_shift_count_u64((((shift.wrapping_sub(64)) as u64)) as u64))));
        }
        res.w[1] |= (x_sign | 0x3040000000000000);
        return res;
    } else {
