// Auto-generated from to_int32_rninta.go by go2rs. Do not edit.

use super::prelude::*;

pub fn bid64_to_int32_rninta(mut x: u64) -> (i32, u32) {
    let mut res: i32 = 0;
    ...
    if (((q.wrapping_add(exp))) > 10) {
        ...
        if (x_sign != 0) {
            if (q <= 11) {
                ...
                tmp64 = ((0x500000005 as u64).wrapping_mul(bid_ten2k64[(q.wrapping_sub(11)) as usize]));
                if (C1 >= tmp64) {
                    pfpsf |= 1;
                    res = (-0x80000000);
                    return (res, pfpsf);
            ...
            if (q <= 11) {
                ...
                tmp64 = ((0x4fffffffb as u64).wrapping_mul(bid_ten2k64[(q.wrapping_sub(11)) as usize]));
                if (C1 >= tmp64) {
                    pfpsf |= 1;
                    res = (-0x80000000);
                    return (res, pfpsf);
...
pub fn bid64_to_int32_xrninta(mut x: u64) -> (i32, u32) {
    let mut res: i32 = 0;
    let mut x_sign: u64 = 0;
    let mut x_exp: u64 = 0;
    let mut exp: i64 = 0;
