// Auto-generated from to_int64_ceil.go by go2rs. Do not edit.

use super::prelude::*;

pub fn bid64_to_int64_ceil(mut x: u64) -> (i64, u32) {
    let mut res: i64 = 0;
    ...
    if (((q.wrapping_add(exp))) > 19) {
        ...
        if (x_sign != 0) {
            ...
            C.w[0] = 0xfffffffffffffff6;
            C = __mul_64x64_to_128(C1, bid_ten2k64[((20 as i64).wrapping_sub(q)) as usize]);
            if ((C.w[1] > 0x04) || (((C.w[1] == 0x04) && (C.w[0] > 0xfffffffffffffff6)))) {
                pfpsf |= 1;
                res = (-0x8000000000000000);
                return (res, pfpsf);
            }
...
pub fn bid64_to_int64_xceil(mut x: u64) -> (i64, u32) {
    let mut res: i64 = 0;
    let mut x_sign: u64 = 0;
    let mut x_exp: u64 = 0;
    let mut exp: i64 = 0;
