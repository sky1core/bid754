// Code generated by go2rs from bid128_fma_body.go; DO NOT EDIT.

// Mechanical Go/C-shaped port of bid754-go/internal/bidgo/bid128_fma_body.go; the style/shape
...
pub(crate) fn bid_fma_delta_ge_zero(mut p34: i64, res: &mut BID_UINT128, ptr_is_midpoint_lt_even: &mut i64, ptr_is_midpoint_gt_even: &mut i64, ptr_is_inexact_lt_midpoint: &mut i64, ptr_is_inexact_gt_midpoint: &mut i64, mut p_sign: u64, mut z_sign: u64, z_exp_ptr: &mut u64, p_exp_ptr: &mut u64, mut q3: i64, mut q4: i64, e3_ptr: &mut i64, e4_ptr: &mut i64, mut delta: i64, C3: &mut BID_UINT128, mut C4: BID_UINT256, mut rnd_mode: i64, pfpsf: &mut u32) {
    ...
    let mut R128: BID_UINT128 = BID_UINT128 { lo: 0, hi: 0 };
    ...
    if ((p34 <= (delta.wrapping_sub(1))) || (((p34 == delta) && ((e3.wrapping_add(6176)) < (p34.wrapping_sub(q3)))))) {
        ...
        if (q3 < p34) {
            ...
            scale = 0;
            res.hi = ((z_sign | ((go_checked_shl_u64(((e3.wrapping_add(6176)) as u64), go_shift_count_u64((49) as u64))))) | C3.hi);
            res.lo = C3.lo;
        }
        if ((p_sign != z_sign) && ((delta == (((q3.wrapping_add(scale)).wrapping_add(1)))))) {
            if (((((q3 <= 19) && (C3.lo != bid_ten2k64[(q3.wrapping_sub(1)) as usize]))) || (((q3 == 20) && (((C3.hi != 0) || (C3.lo != bid_ten2k64[19])))))) || (((q3 >= 21) && (((C3.hi != bid_ten2k128[(q3.wrapping_sub(21)) as usize].hi) || (C3.lo != bid_ten2k128[(q3.wrapping_sub(21)) as usize].lo)))))) {
                is_inexact_gt_midpoint = 1;
            } else {
                if (q4 == 1) {
                    R64 = C4.w0;
                    ...
                    if (q4 <= 18) {
                        R64 = bid_round64_2_18(q4, (q4.wrapping_sub(1)), C4.w0, (&mut incr_exp), (&mut is_midpoint_lt_even), (&mut is_midpoint_gt_even), (&mut is_inexact_lt_midpoint), (&mut is_inexact_gt_midpoint));
                    } else if (q4 <= 38) {
                        P128.hi = C4.w1;
                        P128.lo = C4.w0;
                ...
                if (((((R64 == 5) && (is_inexact_lt_midpoint == 0)) && (is_inexact_gt_midpoint == 0)) && (is_midpoint_lt_even == 0)) && (is_midpoint_gt_even == 0)) {
                    ...
                    if (((q3.wrapping_add(scale))) <= 19) {
                        res.hi = 0;
                        res.lo = bid_ten2k64[(q3.wrapping_add(scale)) as usize];
                    } else {
                        res.hi = bid_ten2k128[((q3.wrapping_add(scale)).wrapping_sub(20)) as usize].hi;
                        res.lo = bid_ten2k128[((q3.wrapping_add(scale)).wrapping_sub(20)) as usize].lo;
                    }
        ...
        gt_half_ulp = 0;
        if (q4 <= 19) {
            if (C4.w0 < bid_midpoint64[(q4.wrapping_sub(1)) as usize]) {
                lt_half_ulp = 1;
            } else if (C4.w0 == bid_midpoint64[(q4.wrapping_sub(1)) as usize]) {
                eq_half_ulp = 1;
            } else {
                gt_half_ulp = 1;
            }
        } else if (q4 <= 38) {
            if ((C4.w2 == 0) && (((C4.w1 < bid_midpoint128[(q4.wrapping_sub(20)) as usize].hi) || (((C4.w1 == bid_midpoint128[(q4.wrapping_sub(20)) as usize].hi) && (C4.w0 < bid_midpoint128[(q4.wrapping_sub(20)) as usize].lo)))))) {
                lt_half_ulp = 1;
            } else if (((C4.w2 == 0) && (C4.w1 == bid_midpoint128[(q4.wrapping_sub(20)) as usize].hi)) && (C4.w0 == bid_midpoint128[(q4.wrapping_sub(20)) as usize].lo)) {
                eq_half_ulp = 1;
            } else {
                gt_half_ulp = 1;
            }
        } else if (q4 <= 58) {
            if ((C4.w3 == 0) && ((((C4.w2 < bid_midpoint192[(q4.wrapping_sub(39)) as usize].w2) || (((C4.w2 == bid_midpoint192[(q4.wrapping_sub(39)) as usize].w2) && (C4.w1 < bid_midpoint192[(q4.wrapping_sub(39)) as usize].w1)))) || ((((C4.w2 == bid_midpoint192[(q4.wrapping_sub(39)) as usize].w2) && (C4.w1 == bid_midpoint192[(q4.wrapping_sub(39)) as usize].w1)) && (C4.w0 < bid_midpoint192[(q4.wrapping_sub(39)) as usize].w0)))))) {
                lt_half_ulp = 1;
            } else if ((((C4.w3 == 0) && (C4.w2 == bid_midpoint192[(q4.wrapping_sub(39)) as usize].w2)) && (C4.w1 == bid_midpoint192[(q4.wrapping_sub(39)) as usize].w1)) && (C4.w0 == bid_midpoint192[(q4.wrapping_sub(39)) as usize].w0)) {
                eq_half_ulp = 1;
            } else {
                gt_half_ulp = 1;
            }
        } else {
            if ((((C4.w3 < bid_midpoint256[(q4.wrapping_sub(59)) as usize].w3) || (((C4.w3 == bid_midpoint256[(q4.wrapping_sub(59)) as usize].w3) && (C4.w2 < bid_midpoint256[(q4.wrapping_sub(59)) as usize].w2)))) || ((((C4.w3 == bid_midpoint256[(q4.wrapping_sub(59)) as usize].w3) && (C4.w2 == bid_midpoint256[(q4.wrapping_sub(59)) as usize].w2)) && (C4.w1 < bid_midpoint256[(q4.wrapping_sub(59)) as usize].w1)))) || (((((C4.w3 == bid_midpoint256[(q4.wrapping_sub(59)) as usize].w3) && (C4.w2 == bid_midpoint256[(q4.wrapping_sub(59)) as usize].w2)) && (C4.w1 == bid_midpoint256[(q4.wrapping_sub(59)) as usize].w1)) && (C4.w0 < bid_midpoint256[(q4.wrapping_sub(59)) as usize].w0)))) {
                lt_half_ulp = 1;
            } else if ((((C4.w3 == bid_midpoint256[(q4.wrapping_sub(59)) as usize].w3) && (C4.w2 == bid_midpoint256[(q4.wrapping_sub(59)) as usize].w2)) && (C4.w1 == bid_midpoint256[(q4.wrapping_sub(59)) as usize].w1)) && (C4.w0 == bid_midpoint256[(q4.wrapping_sub(59)) as usize].w0)) {
                eq_half_ulp = 1;
            } else {
                gt_half_ulp = 1;
            }
        ...
        if (p_sign == z_sign) {
            if (lt_half_ulp != 0) {
                ...
                if (((res.hi & 0x1ffffffffffff) == 0x0001ed09bead87c0) && (res.lo == 0x378d8e6400000000)) {
    ...
    if ((res.hi != 0x0000314dc6448d93) || (res.lo != 0x38c15b0a00000000)) {
        ...
        if (e3 > -6176) {
            if (q4 == 1) {
                ...
                res.lo = ((0x378d8e6400000000 as u64).wrapping_sub(C4.w0));
                z_exp = (z_exp.wrapping_sub(0x2000000000000));
                e3 = (e3.wrapping_sub(1));
                res.hi = ((z_sign | (z_exp & 0x7ffe000000000000)) | res.hi);
            } else {
                ...
                if ((((is_midpoint_lt_even == 0) && (is_midpoint_gt_even == 0)) && (is_inexact_lt_midpoint == 0)) && (is_inexact_gt_midpoint == 0)) {
                    z_exp = (z_exp.wrapping_sub(0x2000000000000));
                    e3 = (e3.wrapping_sub(1));
                    res.hi = ((z_sign | (z_exp & 0x7ffe000000000000)) | 0x0001ed09bead87c0);
                    res.lo = ((0x378d8e6400000000 as u64).wrapping_sub(R64));
                } else {
                    if (incr_exp != 0) {
                        R64 = 10;
                    }
...
pub(crate) fn bid_fma_cases_2_to_6(mut p34: i64, res: &mut BID_UINT128, ptr_is_midpoint_lt_even: &mut i64, ptr_is_midpoint_gt_even: &mut i64, ptr_is_inexact_lt_midpoint: &mut i64, ptr_is_inexact_gt_midpoint: &mut i64, mut p_sign: u64, mut z_sign: u64, z_exp_ptr: &mut u64, mut q3: i64, mut q4: i64, e3_ptr: &mut i64, e4_ptr: &mut i64, mut delta: i64, C3: &mut BID_UINT128, mut C4: BID_UINT256, mut rnd_mode: i64, pfpsf: &mut u32) {
    ...
    if (((((q3 <= delta) && (delta < p34)) && (p34 < (delta.wrapping_add(q4))))) || (((delta < q3) && (p34 < (delta.wrapping_add(q4)))))) {
        ...
        if (q4 <= 19) {
            if (scale <= 19) {
                P128 = __mul_64x64_to_128(C4.w0, bid_ten2k64[scale as usize]);
            } else {
                P128 = __mul_128x64_to_128(C4.w0, bid_ten2k128[(scale.wrapping_sub(20)) as usize]);
            }
        } else {
            let mut C4_128: BID_UINT128 = BID_UINT128 { lo: 0, hi: 0 };
            C4_128.lo = C4.w0;
            C4_128.hi = C4.w1;
    ...
    loop {
        if (scale == 0) {
            ...
            if (scale <= 19) {
                ...
                (*res) = __mul_128x64_to_128(C3.lo, bid_ten2k128[(scale.wrapping_sub(20)) as usize]);
            }
        } else {
        ...
        if (x0 == 0) {
            ...
            R64 = bid_round64_2_18(q4, x0, C4.w0, (&mut incr_exp), (&mut is_midpoint_lt_even), (&mut is_midpoint_gt_even), (&mut is_inexact_lt_midpoint), (&mut is_inexact_gt_midpoint));
            if (incr_exp != 0) {
            ...
            if (incr_exp != 0) {
                if ((q4.wrapping_sub(x0)) <= 19) {
                    R128.lo = bid_ten2k64[(q4.wrapping_sub(x0)) as usize];
                } else {
                    R128.lo = bid_ten2k128[((q4.wrapping_sub(x0)).wrapping_sub(20)) as usize].lo;
                    R128.hi = bid_ten2k128[((q4.wrapping_sub(x0)).wrapping_sub(20)) as usize].hi;
                }
            }
        } else if (q4 <= 57) {
            P192.w2 = C4.w2;
            ...
            if (incr_exp != 0) {
                if ((q4.wrapping_sub(x0)) <= 19) {
                    R192.w0 = bid_ten2k64[(q4.wrapping_sub(x0)) as usize];
                } else {
                    R192.w0 = bid_ten2k128[((q4.wrapping_sub(x0)).wrapping_sub(20)) as usize].lo;
                    R192.w1 = bid_ten2k128[((q4.wrapping_sub(x0)).wrapping_sub(20)) as usize].hi;
                }
            }
            R128.hi = R192.w1;
            R128.lo = R192.w0;
            ...
            if (incr_exp != 0) {
                if ((q4.wrapping_sub(x0)) <= 19) {
                    R256.w0 = bid_ten2k64[(q4.wrapping_sub(x0)) as usize];
                } else {
                    R256.w0 = bid_ten2k128[((q4.wrapping_sub(x0)).wrapping_sub(20)) as usize].lo;
                    R256.w1 = bid_ten2k128[((q4.wrapping_sub(x0)).wrapping_sub(20)) as usize].hi;
                }
            }
            R128.hi = R256.w1;
            R128.lo = R256.w0;
        ...
        if (z_sign == p_sign) {
            lsb = (res.lo & 0x01);
            res.lo = (res.lo.wrapping_add(R128.lo));
            res.hi = (res.hi.wrapping_add(R128.hi));
            if (res.lo < R128.lo) {
                res.hi = res.hi.wrapping_add(1);
            }
            if ((res.hi > 0x0001ed09bead87c0) || (((res.hi == 0x0001ed09bead87c0) && (res.lo > 0x378d8e63ffffffff)))) {
                ...
                if (lsb == 1) {
                    if (is_midpoint_gt_even != 0) {
                        ...
                        if ((res.hi == 0x0001ed09bead87c0) && (res.lo == 0x378d8e6400000000)) {
                            res.hi = 0x0000314dc6448d93;
                            res.lo = 0x38c15b0a00000000;
                            e3 = e3.wrapping_add(1);
                        }
            ...
            lsb = (res.lo & 0x01);
            tmp64 = res.lo;
            res.lo = (res.lo.wrapping_sub(R128.lo));
            res.hi = (res.hi.wrapping_sub(R128.hi));
            if (res.lo > tmp64) {
                res.hi = res.hi.wrapping_sub(1);
            }
            if (((e3 > -6176) && (((((res.hi < 0x0000314dc6448d93) || (((res.hi == 0x0000314dc6448d93) && (res.lo < 0x38c15b0a00000000))))) || (((((is_inexact_lt_midpoint | is_midpoint_gt_even) != 0) && (res.hi == 0x0000314dc6448d93)) && (res.lo == 0x38c15b0a00000000)))))) && (x0 >= 1)) {
        ...
        if (e3 == -6176) {
            ...
            if (((((res.hi & 0x7fffffffffffffff) == 0x0000314dc6448d93)) && (res.lo == 0x38c15b0a00000000)) && (z_sign != p_sign)) {
                is_tiny = 1;
            }
        } else if (e3 < -6176) {
            is_tiny = 1;
            ...
            if (res.hi == 0x0) {
                ind = 1;
                while (ind <= 19) {
                    if (res.lo < bid_ten2k64[ind as usize]) {
                        break;
                    }
                    ind = ind.wrapping_add(1);
                }
            } else if ((res.hi < bid_ten2k128[0].hi) || (((res.hi == bid_ten2k128[0].hi) && (res.lo < bid_ten2k128[0].lo)))) {
                ind = 20;
            } else {
                ind = 1;
                while (ind <= 18) {
                    if ((res.hi < bid_ten2k128[ind as usize].hi) || (((res.hi == bid_ten2k128[ind as usize].hi) && (res.lo < bid_ten2k128[ind as usize].lo)))) {
                        break;
                    }
                    ind = ind.wrapping_add(1);
                }
            ...
            if (x0 == ind) {
                ...
                R64 = bid_round64_2_18(ind, x0, res.lo, (&mut incr_exp), (&mut is_midpoint_lt_even), (&mut is_midpoint_gt_even), (&mut is_inexact_lt_midpoint), (&mut is_inexact_gt_midpoint));
                if (incr_exp != 0) {
                ...
                if (incr_exp != 0) {
                    if ((ind.wrapping_sub(x0)) <= 19) {
                        res.lo = bid_ten2k64[(ind.wrapping_sub(x0)) as usize];
                    } else {
                        res.lo = bid_ten2k128[((ind.wrapping_sub(x0)).wrapping_sub(20)) as usize].lo;
                        res.hi = bid_ten2k128[((ind.wrapping_sub(x0)).wrapping_sub(20)) as usize].hi;
                    }
                }
            }
            if ((((is_inexact_gt_midpoint0 != 0) || (is_midpoint_lt_even0 != 0))) && (is_midpoint_lt_even != 0)) {
        ...
        if (p_sign == z_sign) {
            ...
            if ((res.hi != 0x0000314dc6448d93) || (res.lo != 0x38c15b0a00000000)) {
                ...
                if (delta > (p34.wrapping_add(1))) {
                    ...
                    if (q3 <= 19) {
                        if (C3.lo < bid_midpoint64[(q3.wrapping_sub(1)) as usize]) {
                            is_inexact_gt_midpoint = 1;
                        } else if (C3.lo == bid_midpoint64[(q3.wrapping_sub(1)) as usize]) {
                            is_midpoint_lt_even = 1;
                        } else {
                            res.hi = 0x0001ed09bead87c0;
                        ...
                        if ((C3.hi < bid_midpoint128[(q3.wrapping_sub(20)) as usize].hi) || (((C3.hi == bid_midpoint128[(q3.wrapping_sub(20)) as usize].hi) && (C3.lo < bid_midpoint128[(q3.wrapping_sub(20)) as usize].lo)))) {
                            is_inexact_gt_midpoint = 1;
                        } else if ((C3.hi == bid_midpoint128[(q3.wrapping_sub(20)) as usize].hi) && (C3.lo == bid_midpoint128[(q3.wrapping_sub(20)) as usize].lo)) {
                            is_midpoint_lt_even = 1;
                        } else {
                            res.hi = 0x0001ed09bead87c0;
                            res.lo = 0x378d8e63ffffffff;
...
pub(crate) fn bid_fma_cases_11_12(mut p34: i64, res: &mut BID_UINT128, ptr_is_midpoint_lt_even: &mut i64, ptr_is_midpoint_gt_even: &mut i64, ptr_is_inexact_lt_midpoint: &mut i64, ptr_is_inexact_gt_midpoint: &mut i64, mut p_sign: u64, mut z_sign: u64, mut q3: i64, mut q4: i64, e3_ptr: &mut i64, e4_ptr: &mut i64, mut delta: i64, C3: &mut BID_UINT128, mut C4: BID_UINT256, mut rnd_mode: i64, pfpsf: &mut u32) {
    ...
    let mut R128: BID_UINT128 = BID_UINT128 { lo: 0, hi: 0 };
    let mut P128: BID_UINT128 = BID_UINT128 { lo: 0, hi: 0 };
    let mut P192_128: BID_UINT128 = BID_UINT128 { lo: 0, hi: 0 };
    let mut R192: BID_UINT192 = BID_UINT192 { w0: 0, w1: 0, w2: 0 };
    let mut R256: BID_UINT256 = BID_UINT256 { w0: 0, w1: 0, w2: 0, w3: 0 };
    let mut incr_exp: i64 = 0;
    let mut ind: i64 = 0;
    ...
    if (q3 <= 18) {
        R64 = bid_round64_2_18(q3, x0, C3.lo, (&mut incr_exp), (&mut is_midpoint_lt_even), (&mut is_midpoint_gt_even), (&mut is_inexact_lt_midpoint), (&mut is_inexact_gt_midpoint));
        C3.lo = R64;
    } else if (q3 <= 38) {
    ...
    if (p_sign == z_sign) {
        ...
        if (is_inexact_lt_midpoint != 0) {
            ...
            if (is_midpoint_lt_even != 0) {
                R256.w0 = R256.w0.wrapping_add(1);
                if (R256.w0 == 0) {
                    R256.w1 = R256.w1.wrapping_add(1);
                    if (R256.w1 == 0) {
                        R256.w2 = R256.w2.wrapping_add(1);
                        if (R256.w2 == 0) {
                            R256.w3 = R256.w3.wrapping_add(1);
                        }
                    }
                }
            } else if (is_midpoint_gt_even != 0) {
                R256.w0 = R256.w0.wrapping_sub(1);
                if (R256.w0 == 0xffffffffffffffff) {
                    R256.w1 = R256.w1.wrapping_sub(1);
    ...
    if (rnd_mode == 0) {
        ...
        let mut scale = (((go_checked_shr_u64((P128.hi & 0x7ffe000000000000), go_shift_count_u64((49) as u64))) as i64).wrapping_sub(6176));
    ...
    if (e4 < -6176) {
        ...
        if (x0 > ind) {
            ...
            R128.hi = (res.hi & 0x1ffffffffffff);
            R128.lo = res.lo;
            if (ind <= 19) {
                if (R128.lo < bid_midpoint64[(ind.wrapping_sub(1)) as usize]) {
                    lt_half_ulp = 1;
                    is_inexact_lt_midpoint = 1;
                } else if (R128.lo == bid_midpoint64[(ind.wrapping_sub(1)) as usize]) {
                    eq_half_ulp = 1;
                    is_midpoint_gt_even = 1;
                } else {
                    gt_half_ulp = 1;
                ...
                if ((R128.hi < bid_midpoint128[(ind.wrapping_sub(20)) as usize].hi) || (((R128.hi == bid_midpoint128[(ind.wrapping_sub(20)) as usize].hi) && (R128.lo < bid_midpoint128[(ind.wrapping_sub(20)) as usize].lo)))) {
                    lt_half_ulp = 1;
                    is_inexact_lt_midpoint = 1;
                } else if ((R128.hi == bid_midpoint128[(ind.wrapping_sub(20)) as usize].hi) && (R128.lo == bid_midpoint128[(ind.wrapping_sub(20)) as usize].lo)) {
                    eq_half_ulp = 1;
                    is_midpoint_gt_even = 1;
                } else {
                    gt_half_ulp = 1;
            ...
            if (ind <= 18) {
                ...
                P128.hi = (res.hi & 0x1ffffffffffff);
                P128.lo = res.lo;
            ...
            res.hi = ((p_sign | ((go_checked_shl_u64(((e4.wrapping_add(6176)) as u64), go_shift_count_u64((49) as u64))))) | (res.hi & 0x1ffffffffffff));
            if ((((is_inexact_gt_midpoint0 != 0) || (is_midpoint_lt_even0 != 0))) && (is_midpoint_lt_even != 0)) {
                res.lo = res.lo.wrapping_sub(1);
                if (res.lo == 0xffffffffffffffff) {
                    res.hi = res.hi.wrapping_sub(1);
    ...
    if (((((res.hi & 0x7fffffffffffffff) == 0x0000314dc6448d93) && (res.lo == 0x38c15b0a00000000))) && (((((((rnd_mode == 0) || (rnd_mode == 4))) && (((is_midpoint_lt_even != 0) || (is_inexact_gt_midpoint != 0))))) || (((((((rnd_mode == 2) && (((res.hi & 0x8000000000000000) == 0)))) || (((rnd_mode == 1) && (((res.hi & 0x8000000000000000) != 0)))))) && (((((is_midpoint_lt_even != 0) || (is_midpoint_gt_even != 0)) || (is_inexact_lt_midpoint != 0)) || (is_inexact_gt_midpoint != 0)))))))) {
        is_tiny = 1;
    }
    if ((((is_midpoint_lt_even != 0) || (is_midpoint_gt_even != 0)) || (is_inexact_lt_midpoint != 0)) || (is_inexact_gt_midpoint != 0)) {
        (*pfpsf) |= 32;
...
pub(crate) fn bid_add_and_round(mut q3: i64, mut q4: i64, mut e4: i64, mut delta: i64, mut p34: i64, mut z_sign: u64, mut p_sign: u64, mut C3: BID_UINT128, mut C4: BID_UINT256, mut rnd_mode: i64, ptr_is_midpoint_lt_even: &mut i64, ptr_is_midpoint_gt_even: &mut i64, ptr_is_inexact_lt_midpoint: &mut i64, ptr_is_inexact_gt_midpoint: &mut i64, ptrfpsf: &mut u32, ptrres: &mut BID_UINT128) {
    ...
    if (scale == 0) {
        ...
        P128.hi = 0;
        P128.lo = bid_ten2k64[scale as usize];
        ...
        R128 = __mul_64x128_to_128(C3.lo, bid_ten2k128[(scale.wrapping_sub(58)) as usize]);
        R256 = __mul_128x128_to_256(R128, bid_ten2k128[18]);
    }
    if (p_sign == z_sign) {
        R256 = bid_add256(C4, R256);
    } else {
        if ((((R256.w3 > C4.w3) || (((R256.w3 == C4.w3) && (R256.w2 > C4.w2)))) || ((((R256.w3 == C4.w3) && (R256.w2 == C4.w2)) && (R256.w1 > C4.w1)))) || (((((R256.w3 == C4.w3) && (R256.w2 == C4.w2)) && (R256.w1 == C4.w1)) && (R256.w0 >= C4.w0)))) {
            R256 = bid_sub256(R256, C4);
            p_sign = z_sign;
        } else {
            R256 = bid_sub256(C4, R256);
        }
        if ((((R256.w3 == 0x0) && (R256.w2 == 0x0)) && (R256.w1 == 0x0)) && (R256.w0 == 0x0)) {
            if (rnd_mode != 1) {
            ...
            res.hi = (p_sign | ((go_checked_shl_u64(((e4.wrapping_add(6176)) as u64), go_shift_count_u64((49) as u64)))));
            res.lo = 0x0;
            (*ptrres) = res;
            return;
        }
    ...
    if (ind <= p34) {
        ...
        res.hi = ((p_sign | ((go_checked_shl_u64(((e4.wrapping_add(6176)) as u64), go_shift_count_u64((49) as u64))))) | R256.w1);
        res.lo = R256.w0;
    } else {
        x0 = (ind.wrapping_sub(p34));
        if (ind <= 38) {
        ...
        if (rnd_mode == 0) {
            ...
            scale = (((go_checked_shr_u64((P128.hi & 0x7ffe000000000000), go_shift_count_u64((49) as u64))) as i64).wrapping_sub(6176));
        }
        ind = p34;
        res.hi = ((p_sign | ((go_checked_shl_u64(((e4.wrapping_add(6176)) as u64), go_shift_count_u64((49) as u64))))) | R128.hi);
        res.lo = R128.lo;
    }
    if ((rnd_mode == 0) && (((ind.wrapping_add(e4))) > ((p34.wrapping_add(0x17df))))) {
        res.hi = (p_sign | 0x7800000000000000);
...
pub(crate) fn bid_bid_nr_digits256(mut R256: BID_UINT256) -> i64 {
    ...
    if (((R256.w3 == 0x0) && (R256.w2 == 0x0)) && (R256.w1 == 0x0)) {
        ind = 1;
        while (ind <= 19) {
            if (R256.w0 < bid_ten2k64[ind as usize]) {
                break;
            }
            ind = ind.wrapping_add(1);
        }
    } else if (((R256.w3 == 0x0) && (R256.w2 == 0x0)) && (((R256.w1 < bid_ten2k128[0].hi) || (((R256.w1 == bid_ten2k128[0].hi) && (R256.w0 < bid_ten2k128[0].lo)))))) {
        ind = 20;
    } else if ((R256.w3 == 0x0) && (R256.w2 == 0x0)) {
        ind = 1;
        while (ind <= 18) {
            if ((R256.w1 < bid_ten2k128[ind as usize].hi) || (((R256.w1 == bid_ten2k128[ind as usize].hi) && (R256.w0 < bid_ten2k128[ind as usize].lo)))) {
                break;
            }
            ind = ind.wrapping_add(1);
        }
        ind = (ind.wrapping_add(20));
    } else if ((R256.w3 == 0x0) && ((((R256.w2 < bid_ten2k256[0].w2) || (((R256.w2 == bid_ten2k256[0].w2) && (R256.w1 < bid_ten2k256[0].w1)))) || ((((R256.w2 == bid_ten2k256[0].w2) && (R256.w1 == bid_ten2k256[0].w1)) && (R256.w0 < bid_ten2k256[0].w0)))))) {
        ind = 39;
    } else {
        ind = 1;
        while (ind <= 29) {
            if ((((R256.w3 < bid_ten2k256[ind as usize].w3) || (((R256.w3 == bid_ten2k256[ind as usize].w3) && (R256.w2 < bid_ten2k256[ind as usize].w2)))) || ((((R256.w3 == bid_ten2k256[ind as usize].w3) && (R256.w2 == bid_ten2k256[ind as usize].w2)) && (R256.w1 < bid_ten2k256[ind as usize].w1)))) || (((((R256.w3 == bid_ten2k256[ind as usize].w3) && (R256.w2 == bid_ten2k256[ind as usize].w2)) && (R256.w1 == bid_ten2k256[ind as usize].w1)) && (R256.w0 < bid_ten2k256[ind as usize].w0)))) {
                break;
            }
            ind = ind.wrapping_add(1);
        }
