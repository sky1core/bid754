// Auto-generated from to_uint64_ceil.go by go2rs. Do not edit.

use super::prelude::*;

pub fn bid64_to_uint64_ceil(mut x: u64) -> (u64, u32) {
    let mut res: u64 = 0;
    ...
    if (((q.wrapping_add(exp))) > 20) {
        ...
        if (x_sign != 0) {
            ...
            if (q == 1) {
                ...
                if ((C.w[1] > 0x09) || (((C.w[1] == 0x09) && (C.w[0] > 0xfffffffffffffff6)))) {
                    pfpsf |= 1;
                    res = 0x8000000000000000;
                    return (res, pfpsf);
                }
    ...
    if (((q.wrapping_add(exp))) <= 0) {
        ...
        if (exp < 0) {
            ...
            res = (C1.wrapping_mul(bid_ten2k64[exp as usize]));
        }
    }
    return (res, pfpsf);
}

pub fn bid64_to_uint64_xceil(mut x: u64) -> (u64, u32) {
    let mut res: u64 = 0;
    let mut x_sign: u64 = 0;
    let mut x_exp: u64 = 0;
    let mut exp: i64 = 0;
