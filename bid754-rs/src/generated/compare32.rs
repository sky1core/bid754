// Code generated by go2rs from compare32.go; DO NOT EDIT.

// Mechanical Go/C-shaped port of bid754-go/internal/bidgo/compare32.go; the style/shape
...
// Intel BID C's macro-generated comparison logic mechanically ports through
// bid754-go/internal/bidgo/compare32.go into a self-comparison here
// (e.g. "0 == 0"): a faithful port of the upstream operand shape, not a bug.
// Allow the deny-by-default clippy::eq_op lint instead of rewriting the ported
// comparison, which would diverge this file from its Go/Intel source of truth.
#![allow(clippy::eq_op)]
