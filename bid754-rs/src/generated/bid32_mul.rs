// Code generated by go2rs from bid32_mul.go; DO NOT EDIT.

// Mechanical Go/C-shaped port of bid754-go/internal/bidgo/bid32_mul.go; the style/shape
...
pub(crate) fn bid32_mul_core(mut x: u32, mut y: u32, mut rndMode: i64) -> (u32, u32) {
    let mut Tmp: BID_UINT128 = BID_UINT128 { w: [0, 0] };
    let mut P: u64 = 0;
    let mut Q: u64 = 0;
    let mut R: u64 = 0;
    ...
    exponent_x = exponent_x.wrapping_add(extra_digits);
    if (extra_digits == 0) {
        res = get_bid32_flags((sign_x ^ sign_y), exponent_x, P, rndMode, (&mut flags));
        return (res, flags);
    }
    rmode = rndMode;
    if (((sign_x ^ sign_y) != 0) && (((rmode.wrapping_sub(1)) as u64) < 2)) {
    ...
    res = get_bid32_uf((sign_x ^ sign_y), exponent_x, Q, (R as u32), rndMode, (&mut flags));
    return (res, flags);
}
