// Code generated by go2rs from bid32_logb.go; DO NOT EDIT.

// Mechanical Go/C-shaped port of bid754-go/internal/bidgo/bid32_logb.go; the style/shape
...
pub fn bid32_i_logb(mut x: u32) -> (i64, u32) {
    ...
    if (coefficient_x >= 1000000) {
        ...
        if ((coefficient_x as u64) >= bid_power10_table_128[digits as usize].lo) {
