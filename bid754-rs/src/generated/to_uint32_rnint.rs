// Auto-generated from to_uint32_rnint.go by go2rs. Do not edit.

use super::prelude::*;

pub fn bid64_to_uint32_rnint(mut x: u64) -> (u32, u32) {
    let mut res: u32 = 0;
...
pub fn bid64_to_uint32_xrnint(mut x: u64) -> (u32, u32) {
    let mut res: u32 = 0;
    let mut x_sign: u64 = 0;
    let mut x_exp: u64 = 0;
    let mut exp: i64 = 0;
