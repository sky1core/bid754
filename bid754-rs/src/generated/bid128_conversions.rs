// Code generated by go2rs from bid128_conversions.go; DO NOT EDIT.

// Mechanical Go/C-shaped port of bid754-go/internal/bidgo/bid128_conversions.go; the style/shape
...
pub fn bid128_to_bid64(mut x: BID_UINT128, mut rnd_mode: i64) -> (u64, u32) {
    ...
    if (!valid) {
        if (((go_checked_shl_u64(x.hi, go_shift_count_u64((1) as u64)))) >= 0xf000000000000000) {
    ...
    if ((CX.hi != 0) || (CX.lo >= 10000000000000000)) {
        ...
        CX.hi = ((CX.hi.wrapping_add(T128.hi)).wrapping_add(carry));
        ...
        if (amount >= 64) {
            CX.lo = (go_checked_shr_u64(Qh.hi, go_shift_count_u64((((amount.wrapping_sub(64)) as u64)) as u64)));
            CX.hi = 0;
        } else {
        ...
        if (rnd_mode == 0) {
            if ((CX.lo & 1) != 0) {
                ...
                if (((Qh1.hi == 0) && (Qh1.lo == 0)) && (((Ql.hi < bid_reciprocals10_128[extra_digits as usize].hi) || (((Ql.hi == bid_reciprocals10_128[extra_digits as usize].hi) && (Ql.lo < bid_reciprocals10_128[extra_digits as usize].lo)))))) {
                    CX.lo = CX.lo.wrapping_sub(1);
                }
            }
        }
        status = 32;
        ...
        match rmode {
            0 | 4 => {
                if (((Qh1.hi == 0x8000000000000000) && (Qh1.lo == 0)) && (((Ql.hi < bid_reciprocals10_128[extra_digits as usize].hi) || (((Ql.hi == bid_reciprocals10_128[extra_digits as usize].hi) && (Ql.lo < bid_reciprocals10_128[extra_digits as usize].lo)))))) {
                    status = 0;
                }
            }
            1 | 3 => {
            ...
            _ => {
                (Stemp.lo, cy) = __add_carry_out(Ql.lo, bid_reciprocals10_128[extra_digits as usize].lo);
                (Stemp.hi, carry) = __add_carry_in_out(Ql.hi, bid_reciprocals10_128[extra_digits as usize].hi, cy);
    ...
    let (mut res, mut flags) = get_bid64_flags(sign_x, ((exponent_x.wrapping_sub(0x1820)).wrapping_add(0x18e)), CX.lo, rnd_mode);
    pfpsf |= flags;
    return (res, pfpsf);
}
...
pub fn bid128_to_bid32(mut x: BID_UINT128, mut rnd_mode: i64) -> (u32, u32) {
    ...
    if (!valid) {
        if ((x.hi & 0x7800000000000000) == 0x7800000000000000) {
            ...
            res = (((((go_checked_shr_u64(CX.hi, go_shift_count_u64((32) as u64)))) & 0xfc000000) as u32) | ((go_checked_shr_u64(Qh.hi, go_shift_count_u64((amount as u64) as u64))) as u32));
            if ((x.hi & 0x7e00000000000000) == 0x7e00000000000000) {
                pfpsf |= 1;
            }
            _ = Ql;
