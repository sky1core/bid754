// Code generated by go2rs from bid32_div.go; DO NOT EDIT.

// Mechanical Go/C-shaped port of bid754-go/internal/bidgo/bid32_div.go; the style/shape
...
pub(crate) fn bid32_div_core(mut x: u32, mut y: u32, mut rndMode: i64) -> (u32, u32) {
    let mut CA: u64 = 0;
    let mut sign_x: u32 = 0;
    let mut sign_y: u32 = 0;
    let mut coefficient_x: u32 = 0;
    ...
    if (!valid_x) {
        ...
        if ((x & 0x7c000000) == 0x7c000000) {
            ...
            return ((coefficient_x & 0xfdffffff), flags);
        }
        if ((x & 0x78000000) == 0x78000000) {
            if ((y & 0x78000000) == 0x78000000) {
                if ((y & 0x7c000000) == 0x78000000) {
                    flags |= 1;
                    return (0x7c000000, flags);
                }
            } else {
                return (((((x ^ y) & 0x80000000)) | 0x78000000), flags);
            }
        }
        if ((((y & 0x78000000) != 0x78000000)) && (coefficient_y == 0)) {
            flags |= 1;
        ...
        if ((y & 0x78000000) != 0x78000000) {
            ...
            return (((sign_x ^ sign_y) | ((go_checked_shl_u32((exponent_x as u32), go_shift_count_u64((23) as u64))))), flags);
        }
    }
    if (!valid_y) {
        if ((y & 0x7c000000) == 0x7c000000) {
            ...
            return ((coefficient_y & 0xfdffffff), flags);
        }
        if ((y & 0x78000000) == 0x78000000) {
            return (((x ^ y) & 0x80000000), flags);
        }
        flags |= 4;
        return (((sign_x ^ sign_y) | 0x78000000), flags);
    }
    diff_expon = ((exponent_x.wrapping_sub(exponent_y)).wrapping_add(101));
    if (coefficient_x < coefficient_y) {
        let mut tempx = (coefficient_x as f32);
        ...
        bin_expon_cx = ((((go_checked_shr_u32((tempq as f32).to_bits(), go_shift_count_u64((23) as u64)))) as i64).wrapping_sub(0x7f));
        if (R == 0) {
            res = get_bid32_flags((sign_x ^ sign_y), diff_expon, (Q as u64), rndMode, (&mut flags));
            return (res, flags);
        }
        DU = (((bid_power10_index_binexp[bin_expon_cx as usize] as u32).wrapping_sub(Q)).wrapping_sub(1));
        DU = go_checked_shr_u32(DU, go_shift_count_u64((31) as u64));
    ...
    if (diff_expon >= 0) {
        ...
        if ((diff_expon.wrapping_add(7)) < 0) {
            flags |= 32;
        }
        rmode = rndMode;
        res = get_bid32_uf((sign_x ^ sign_y), diff_expon, (Q as u64), R, rmode, (&mut flags));
        return (res, flags);
    }
}
