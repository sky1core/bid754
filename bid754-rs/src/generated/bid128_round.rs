...
pub(crate) fn bid_round128_19_38(mut q: i64, mut x: i64, mut C: BID_UINT128) -> (BID_UINT128, i64, i64, i64, i64, i64) {
    ...
    if (ind <= 18) {
        Cstar.lo = (((go_checked_shr_u64(P256.w[2], go_shift_count_u64((shift as u64) as u64)))) | ((go_checked_shl_u64(P256.w[3], go_shift_count_u64(((((64 as i64).wrapping_sub(shift)) as u64)) as u64)))));
        Cstar.hi = ((go_checked_shr_u64(P256.w[3], go_shift_count_u64((shift as u64) as u64))));
        fstar.w[0] = P256.w[0];
        fstar.w[1] = P256.w[1];
        fstar.w[2] = (P256.w[2] & bid_mask128[ind as usize]);
        fstar.w[3] = 0x0;
    } else {
        Cstar.lo = (go_checked_shr_u64(P256.w[3], go_shift_count_u64((shift as u64) as u64)));
        Cstar.hi = 0x0;
        fstar.w[0] = P256.w[0];
        fstar.w[1] = P256.w[1];
        fstar.w[2] = P256.w[2];
    ...
    if (ind <= 18) {
        if ((fstar.w[2] > bid_half128[ind as usize]) || (((fstar.w[2] == bid_half128[ind as usize]) && (((fstar.w[1] != 0) || (fstar.w[0] != 0)))))) {
            ...
            if (((tmp64 != 0) || (fstar.w[1] > bid_ten2mxtrunc128[ind as usize].hi)) || (((fstar.w[1] == bid_ten2mxtrunc128[ind as usize].hi) && (fstar.w[0] > bid_ten2mxtrunc128[ind as usize].lo)))) {
        ...
        if ((fstar.w[3] > bid_half128[ind as usize]) || (((fstar.w[3] == bid_half128[ind as usize]) && ((((fstar.w[2] != 0) || (fstar.w[1] != 0)) || (fstar.w[0] != 0)))))) {
            ...
            if ((((tmp64 != 0) || (fstar.w[2] != 0)) || (fstar.w[1] > bid_ten2mxtrunc128[ind as usize].hi)) || (((fstar.w[1] == bid_ten2mxtrunc128[ind as usize].hi) && (fstar.w[0] > bid_ten2mxtrunc128[ind as usize].lo)))) {
                is_inexact_lt_midpoint = 1;
            }
        } else {
            is_inexact_gt_midpoint = 1;
    ...
    if (((fstar.w[3] == 0) && (fstar.w[2] == 0)) && (((fstar.w[1] < bid_ten2mxtrunc128[ind as usize].hi) || (((fstar.w[1] == bid_ten2mxtrunc128[ind as usize].hi) && (fstar.w[0] <= bid_ten2mxtrunc128[ind as usize].lo)))))) {
        if ((Cstar.lo & 0x01) != 0) {
...
pub(crate) fn bid_round192_39_57(mut q: i64, mut x: i64, mut C: BID_UINT192) -> (BID_UINT192, i64, i64, i64, i64, i64) {
    ...
    if (ind <= 18) {
        ...
        tmp64 = C.w[0];
        C.w[0] = (C.w[0].wrapping_add(bid_midpoint128[(ind.wrapping_sub(19)) as usize].lo));
        if (C.w[0] < tmp64) {
            C.w[1] = C.w[1].wrapping_add(1);
            if (C.w[1] == 0x0) {
                C.w[2] = C.w[2].wrapping_add(1);
        ...
        tmp64 = C.w[1];
        C.w[1] = (C.w[1].wrapping_add(bid_midpoint128[(ind.wrapping_sub(19)) as usize].hi));
        if (C.w[1] < tmp64) {
            C.w[2] = C.w[2].wrapping_add(1);
        }
    } else {
    ...
    if (ind <= 19) {
        ...
        if (((Cstar.w[2] == 0x0) && (Cstar.w[1] == bid_ten2k128[0].hi)) && (Cstar.w[0] == bid_ten2k128[0].lo)) {
        ...
        if (((Cstar.w[2] == 0x0) && (Cstar.w[1] == bid_ten2k128[(ind.wrapping_sub(20)) as usize].hi)) && (Cstar.w[0] == bid_ten2k128[(ind.wrapping_sub(20)) as usize].lo)) {
            Cstar.w[0] = bid_ten2k128[(ind.wrapping_sub(21)) as usize].lo;
            Cstar.w[1] = bid_ten2k128[(ind.wrapping_sub(21)) as usize].hi;
            incr_exp = 1;
        } else {
            incr_exp = 0;
        }
...
pub(crate) fn bid_round256_58_76(mut q: i64, mut x: i64, mut C: BID_UINT256) -> (BID_UINT256, i64, i64, i64, i64, i64) {
    ...
    if (ind <= 19) {
        ...
        if ((((Cstar.w[3] == 0x0) && (Cstar.w[2] == 0x0)) && (Cstar.w[1] == bid_ten2k128[0].hi)) && (Cstar.w[0] == bid_ten2k128[0].lo)) {
            Cstar.w[0] = bid_ten2k64[19];
            Cstar.w[1] = 0x0;
            incr_exp = 1;
        } else {
        ...
        if ((((Cstar.w[3] == 0x0) && (Cstar.w[2] == 0x0)) && (Cstar.w[1] == bid_ten2k128[(ind.wrapping_sub(20)) as usize].hi)) && (Cstar.w[0] == bid_ten2k128[(ind.wrapping_sub(20)) as usize].lo)) {
            Cstar.w[0] = bid_ten2k128[(ind.wrapping_sub(21)) as usize].lo;
            Cstar.w[1] = bid_ten2k128[(ind.wrapping_sub(21)) as usize].hi;
            incr_exp = 1;
        } else {
