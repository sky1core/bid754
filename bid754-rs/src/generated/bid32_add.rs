// Code generated by go2rs from bid32_add.go; DO NOT EDIT.

// Mechanical Go/C-shaped port of bid754-go/internal/bidgo/bid32_add.go; the style/shape
...
pub(crate) fn bid32_add_core(mut x: u32, mut y: u32, mut rndMode: i64) -> (u32, u32) {
    ...
    if (n_digits <= 7) {
        res = get_bid32_flags(sign_a, exponent_b, P, rndMode, (&mut flags));
        return (res, flags);
    }
    extra_digits = (n_digits.wrapping_sub(7));
    rmode = rndMode;
    ...
    res = get_bid32_flags(sign_a, (exponent_b.wrapping_add(extra_digits)), Q, rndMode, (&mut flags));
    return (res, flags);
}
...
pub(crate) fn bid32_sub_core(mut x: u32, mut y: u32, mut rndMode: i64) -> (u32, u32) {
    if ((y & 0x7c000000) != 0x7c000000) {
        y ^= 0x80000000;
    }
