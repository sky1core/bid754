// Auto-generated from to_int64_signed.go by go2rs. Do not edit.

use super::prelude::*;

pub fn bid64_to_int64_rnint(mut x: u64) -> (i64, u32) {
    let mut res: i64 = 0;
    ...
    if (((q.wrapping_add(exp))) > 19) {
        ...
        if (x_sign != 0) {
            C = __mul_64x64_to_128(C1, bid_ten2k64[((20 as i64).wrapping_sub(q)) as usize]);
    ...
    if (((q.wrapping_add(exp))) < 0) {
        ...
        ind = (q.wrapping_sub(1));
        if (C1 <= bid_midpoint64[ind as usize]) {
            res = 0x0000000000000000;
        } else if (x_sign != 0) {
            res = (-1);
        } else {
        ...
        if (exp < 0) {
            ...
            if (x_sign != 0) {
                res = ((Cstar as i64).wrapping_neg());
            } else {
                res = (Cstar as i64);
            }
        } else if (exp == 0) {
            if (x_sign != 0) {
                res = ((C1 as i64).wrapping_neg());
            } else {
                res = (C1 as i64);
            }
        } else {
            if (x_sign != 0) {
                res = (((C1.wrapping_mul(bid_ten2k64[exp as usize])) as i64).wrapping_neg());
            } else {
                res = ((C1.wrapping_mul(bid_ten2k64[exp as usize])) as i64);
            }
        }
    }
    return (res, pfpsf);
...
pub fn bid64_to_int64_xrnint(mut x: u64) -> (i64, u32) {
    let mut res: i64 = 0;
    let mut x_sign: u64 = 0;
    let mut x_exp: u64 = 0;
    let mut exp: i64 = 0;
...
pub fn bid64_to_int64_rninta(mut x: u64) -> (i64, u32) {
    let mut res: i64 = 0;
    let mut x_sign: u64 = 0;
    let mut x_exp: u64 = 0;
    let mut exp: i64 = 0;
...
pub fn bid64_to_int64_xrninta(mut x: u64) -> (i64, u32) {
    let mut res: i64 = 0;
    let mut x_sign: u64 = 0;
    let mut x_exp: u64 = 0;
    let mut exp: i64 = 0;
