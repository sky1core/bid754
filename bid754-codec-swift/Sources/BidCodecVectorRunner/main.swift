...
private let expectedRejectTotal = 98
private let expectedRejectConsumed = 93
...
private let expectedBid128 = 12722
private let expectedBid32Canonical = 4464
private let expectedBid64Canonical = 4583
private let expectedBid128Canonical = 6047
...
private func checkRejectVectors(_ rejects: [RejectVector]) {
    ...
    let caps: Set<String> = []
    let unsupportedCaps: Set<String> = ["bignum_coefficient", "negative_coefficient", "negative_payload"]
    var consumed = 0
    var skipped = 0
...
private let anchorVectors: [Vector] = [
    Vector(type: "bid32", hex: "32800001", hex_hi: nil, sign: false, coefficient: "1", exponent: 0, kind: "normal", payload: nil, decimal_string: "+1E+0", canonical: true, encoded_hex: "32800001", encoded_hi: nil),
    Vector(type: "bid32", hex: "b2800000", hex_hi: nil, sign: true, coefficient: "", exponent: 0, kind: "zero", payload: nil, decimal_string: "-0", canonical: true, encoded_hex: "b2800000", encoded_hi: nil),
    Vector(type: "bid32", hex: "7c000001", hex_hi: nil, sign: false, coefficient: "", exponent: 0, kind: "qnan", payload: "1", decimal_string: "+NaN1", canonical: true, encoded_hex: "7c000001", encoded_hi: nil),
    Vector(type: "bid64", hex: "31c0000000000001", hex_hi: nil, sign: false, coefficient: "1", exponent: 0, kind: "normal", payload: nil, decimal_string: "+1E+0", canonical: true, encoded_hex: "31c0000000000001", encoded_hi: nil),
    Vector(type: "bid64", hex: "b1c0000000000000", hex_hi: nil, sign: true, coefficient: "", exponent: 0, kind: "zero", payload: nil, decimal_string: "-0", canonical: true, encoded_hex: "b1c0000000000000", encoded_hi: nil),
    Vector(type: "bid64", hex: "7c00000000000001", hex_hi: nil, sign: false, coefficient: "", exponent: 0, kind: "qnan", payload: "1", decimal_string: "+NaN1", canonical: true, encoded_hex: "7c00000000000001", encoded_hi: nil),
    Vector(type: "bid128", hex: "0000000000000001", hex_hi: "3040000000000000", sign: false, coefficient: "1", exponent: 0, kind: "normal", payload: nil, decimal_string: "+1E+0", canonical: true, encoded_hex: "0000000000000001", encoded_hi: "3040000000000000"),
    Vector(type: "bid128", hex: "0000000000000000", hex_hi: "8000000000000000", sign: true, coefficient: "", exponent: -6176, kind: "zero", payload: nil, decimal_string: "-0E-6176", canonical: true, encoded_hex: "0000000000000000", encoded_hi: "8000000000000000"),
    Vector(type: "bid128", hex: "0000000000000001", hex_hi: "7c00000000000000", sign: false, coefficient: "", exponent: 0, kind: "qnan", payload: "1", decimal_string: "+NaN1", canonical: true, encoded_hex: "0000000000000001", encoded_hi: "7c00000000000000"),
    Vector(type: "bid128", hex: "0000000000000000", hex_hi: "7c00000000000001", sign: false, coefficient: "", exponent: 0, kind: "qnan", payload: "18446744073709551616", decimal_string: "+NaN18446744073709551616", canonical: true, encoded_hex: "0000000000000000", encoded_hi: "7c00000000000001"),
]


private func checkAnchorVectors() {
    if anchorVectors.count != 10 {
