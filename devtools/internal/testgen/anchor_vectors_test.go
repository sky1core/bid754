...
// TestBidCodecVectorAnchorsExistInCheckedInVectors enforces the generator
// contract that every anchor record stays byte-for-byte present in the checked-in
