...
func EncodeSpecFiles(manifest Manifest, spec SharedSpec) (map[string][]byte, error) {
	...
	index := SpecIndex{
		...
		DectestFileInventories:            spec.DectestFileInventories,
		DectestRuntimeSkipInventory:       spec.DectestRuntimeSkipInventory,
		DectestGoportRuntimeSkipInventory: spec.DectestGoportRuntimeSkipInventory,
		ReadtestProfileInventory:          spec.ReadtestProfileInventory,
