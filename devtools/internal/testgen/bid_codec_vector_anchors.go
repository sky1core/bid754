...
var bidCodecVectorAnchors = []bidCodecVectorAnchor{
	...
	{
		// BID128 high-payload NaN: payload 2^64 (bit 64 set in the high word),
		// canonical because 2^64 < 10^33. Pins the 110-bit payload round-trip
		// (decode preserves the full payload, encode splits it back into lo/hi).
		Type: "bid128", Hex: "0000000000000000", HexHi: "7c00000000000001", Sign: false, Coefficient: "", Exponent: 0, Kind: "qnan", Payload: "18446744073709551616",
		DecimalString: "+NaN18446744073709551616", Canonical: true, EncodedHex: "0000000000000000", EncodedHi: "7c00000000000001",
	},
}
