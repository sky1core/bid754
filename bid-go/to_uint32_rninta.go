...
// Bid64ToUint32Rninta is ported mechanically from Intel bid64_to_uint32.c: bid64_to_uint32_rninta.
func Bid64ToUint32Rninta(x uint64) (uint32, uint32) {
	var res uint32
	var x_sign uint64
	var x_exp uint64
...
// Bid64ToUint32Xrninta is ported mechanically from Intel bid64_to_uint32.c: bid64_to_uint32_xrninta.
func Bid64ToUint32Xrninta(x uint64) (uint32, uint32) {
	var res uint32
	var x_sign uint64
	var x_exp uint64
	var exp int // unbiased exponent
