# Intel BID v20U4 Upgrade Verification

This verification records the required source review for the pinned upstream change from
...
the expected changed-file counts and semantic-review exceptions match this
document.
