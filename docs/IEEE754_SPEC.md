...
The full `bid754-rs` crate is the public Rust implementation in pre-release
form and still `publish = false`, with no stable external Rust API defined yet.
...
- `devtools/testgen_manifest.json` 의 해당 readtest 블록에 정확한
