...
// AddWithMode returns the IEEE 754 Decimal32BID sum d + other rounded with mode and the exception flags raised by the operation.
...
func (d Decimal32BID) AddWithMode(other Decimal32BID, mode RoundingMode) (Decimal32BID, ExceptionFlags) {
	return decimal32BIDAddModeFlags(d, other, mode)
}
...
// SubWithMode returns the IEEE 754 Decimal32BID difference d - other rounded with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal32BID) SubWithMode(other Decimal32BID, mode RoundingMode) (Decimal32BID, ExceptionFlags) {
	return decimal32BIDSubModeFlags(d, other, mode)
}
...
// MulWithMode returns the IEEE 754 Decimal32BID product d * other rounded with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal32BID) MulWithMode(other Decimal32BID, mode RoundingMode) (Decimal32BID, ExceptionFlags) {
	return decimal32BIDMulModeFlags(d, other, mode)
}
...
// FMAWithMode returns the IEEE 754 Decimal32BID fused multiply-add d*mul + add rounded once with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal32BID) FMAWithMode(mul, add Decimal32BID, mode RoundingMode) (Decimal32BID, ExceptionFlags) {
	return decimal32BIDFMAModeFlags(d, mul, add, mode)
}
...
// SqrtWithMode returns the IEEE 754 Decimal32BID square root of d rounded with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal32BID) SqrtWithMode(mode RoundingMode) (Decimal32BID, ExceptionFlags) {
	return decimal32BIDSqrtModeFlags(d, mode)
}
...
// DivWithMode returns the IEEE 754 Decimal32BID quotient d / other rounded with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal32BID) DivWithMode(other Decimal32BID, mode RoundingMode) (Decimal32BID, ExceptionFlags) {
	return decimal32BIDDivModeFlags(d, other, mode)
}
...
// QuantizeWithMode returns d quantized to the exponent of other as a Decimal32BID value, rounded with mode, and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal32BID) QuantizeWithMode(other Decimal32BID, mode RoundingMode) (Decimal32BID, ExceptionFlags) {
	return decimal32BIDQuantizeModeFlags(d, other, mode)
}
...
// ScaleBWithMode returns the IEEE 754 scaleB result for d scaled by exponent, rounded with mode at the overflow/underflow boundary, and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal32BID) ScaleBWithMode(exponent int, mode RoundingMode) (Decimal32BID, ExceptionFlags) {
	return decimal32BIDScaleBModeFlags(d, exponent, mode)
}
...
// PrettyString returns the display-oriented string form of d. For a finite
// value, the result is accepted by NewDecimal32 and has the same numeric value.
...
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a NaN result, instead of panicking.
...
// AddWithMode returns the IEEE 754 Decimal64BID sum d + other rounded with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal64BID) AddWithMode(other Decimal64BID, mode RoundingMode) (Decimal64BID, ExceptionFlags) {
	return decimal64BIDAddModeFlags(d, other, mode)
}
...
// SubWithMode returns the IEEE 754 Decimal64BID difference d - other rounded with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal64BID) SubWithMode(other Decimal64BID, mode RoundingMode) (Decimal64BID, ExceptionFlags) {
	return decimal64BIDSubModeFlags(d, other, mode)
}
...
// MulWithMode returns the IEEE 754 Decimal64BID product d * other rounded with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal64BID) MulWithMode(other Decimal64BID, mode RoundingMode) (Decimal64BID, ExceptionFlags) {
	return decimal64BIDMulModeFlags(d, other, mode)
}
...
// FMAWithMode returns the IEEE 754 Decimal64BID fused multiply-add d*mul + add rounded once with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal64BID) FMAWithMode(mul, add Decimal64BID, mode RoundingMode) (Decimal64BID, ExceptionFlags) {
	return decimal64BIDFMAModeFlags(d, mul, add, mode)
}
...
// SqrtWithMode returns the IEEE 754 Decimal64BID square root of d rounded with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal64BID) SqrtWithMode(mode RoundingMode) (Decimal64BID, ExceptionFlags) {
	return decimal64BIDSqrtModeFlags(d, mode)
}
...
// DivWithMode returns the IEEE 754 Decimal64BID quotient d / other rounded with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal64BID) DivWithMode(other Decimal64BID, mode RoundingMode) (Decimal64BID, ExceptionFlags) {
	return decimal64BIDDivModeFlags(d, other, mode)
}
...
// QuantizeWithMode returns d quantized to the exponent of other as a Decimal64BID value, rounded with mode, and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal64BID) QuantizeWithMode(other Decimal64BID, mode RoundingMode) (Decimal64BID, ExceptionFlags) {
	return decimal64BIDQuantizeModeFlags(d, other, mode)
}
...
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal64BID) ScaleBWithMode(exponent int, mode RoundingMode) (Decimal64BID, ExceptionFlags) {
...
// PrettyString returns the display-oriented string form of d. For a finite
// value, the result is accepted by NewDecimal64 and has the same numeric value.
...
// outside the defined constants raises FlagInvalidOperation and returns a
// canonical quiet NaN, instead of panicking.
...
// AddWithMode returns the IEEE 754 Decimal128BID sum d + other rounded with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal128BID) AddWithMode(other Decimal128BID, mode RoundingMode) (Decimal128BID, ExceptionFlags) {
	return decimal128BIDAddModeFlags(d, other, mode)
}
...
// SubWithMode returns the IEEE 754 Decimal128BID difference d - other rounded with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal128BID) SubWithMode(other Decimal128BID, mode RoundingMode) (Decimal128BID, ExceptionFlags) {
	return decimal128BIDSubModeFlags(d, other, mode)
}
...
// MulWithMode returns the IEEE 754 Decimal128BID product d * other rounded with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal128BID) MulWithMode(other Decimal128BID, mode RoundingMode) (Decimal128BID, ExceptionFlags) {
	return decimal128BIDMulModeFlags(d, other, mode)
}
...
// FMAWithMode returns the IEEE 754 Decimal128BID fused multiply-add d*mul + add rounded once with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal128BID) FMAWithMode(mul, add Decimal128BID, mode RoundingMode) (Decimal128BID, ExceptionFlags) {
	return decimal128BIDFMAModeFlags(d, mul, add, mode)
}
...
// SqrtWithMode returns the IEEE 754 Decimal128BID square root of d rounded with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal128BID) SqrtWithMode(mode RoundingMode) (Decimal128BID, ExceptionFlags) {
	return decimal128BIDSqrtModeFlags(d, mode)
}
...
// DivWithMode returns the IEEE 754 Decimal128BID quotient d / other rounded with mode and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal128BID) DivWithMode(other Decimal128BID, mode RoundingMode) (Decimal128BID, ExceptionFlags) {
	return decimal128BIDDivModeFlags(d, other, mode)
}
...
// QuantizeWithMode returns d quantized to the exponent of other as a Decimal128BID value, rounded with mode, and the exception flags raised by the operation.
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal128BID) QuantizeWithMode(other Decimal128BID, mode RoundingMode) (Decimal128BID, ExceptionFlags) {
	return decimal128BIDQuantizeModeFlags(d, other, mode)
}
...
// A RoundingMode outside the defined constants raises FlagInvalidOperation
// and returns a canonical quiet NaN, instead of panicking.
func (d Decimal128BID) ScaleBWithMode(exponent int, mode RoundingMode) (Decimal128BID, ExceptionFlags) {
	return decimal128BIDScaleBModeFlags(d, exponent, mode)
}
...
// PrettyString returns the display-oriented string form of d. For a finite
// value, the result is accepted by NewDecimal128 and has the same numeric value.
...
// NewDecimal32BIDDirect parses s exactly as a Decimal32BID value, reporting
// malformed, inexact, out-of-range, unrepresentable-NaN, or silently coerced
// cohort input as an error.
// ParseDecimal32BIDRaw exposes rounded finite results and exception flags.
func NewDecimal32BIDDirect(s string) (Decimal32BID, error) { return newDecimal32BIDDirectPort(s) }

// NewDecimal64BIDDirect parses s exactly as a Decimal64BID value, reporting
// malformed, inexact, out-of-range, unrepresentable-NaN, or silently coerced
// cohort input as an error.
// ParseDecimal64BIDRaw exposes rounded finite results and exception flags.
func NewDecimal64BIDDirect(s string) (Decimal64BID, error) { return newDecimal64BIDDirectPort(s) }

// NewDecimal128BIDDirect parses s exactly as a Decimal128BID value, reporting
// malformed, inexact, out-of-range, unrepresentable-NaN, or silently coerced
// cohort input as an error.
// ParseDecimal128BIDRaw exposes rounded finite results and exception flags.
func NewDecimal128BIDDirect(s string) (Decimal128BID, error) {
	return newDecimal128BIDDirectPort(s)
}

// ParseDecimal32BIDRaw parses s through the Intel finite-string path and
// returns the exception flags. Malformed syntax, an oversized NaN payload, or
// a finite literal whose cohort the port would otherwise coerce with zero
// status returns canonical quiet NaN plus FlagInvalidOperation rather than
// silently accepting or discarding input.
func ParseDecimal32BIDRaw(s string) (Decimal32BID, ExceptionFlags) {
	return parseDecimal32BIDPort(s)
}

// ParseDecimal64BIDRaw parses s through the Intel finite-string path and
// returns the exception flags. Malformed syntax, an oversized NaN payload, or
// a finite literal whose cohort the port would otherwise coerce with zero
// status returns canonical quiet NaN plus FlagInvalidOperation rather than
// silently accepting or discarding input.
...
// ParseDecimal128BIDRaw parses s through the Intel finite-string path and
// returns the exception flags. Malformed syntax, an oversized NaN payload, or
// a finite literal whose cohort the port would otherwise coerce with zero
// status returns canonical quiet NaN plus FlagInvalidOperation rather than
// silently accepting or discarding input.
