...
var expectedGeneratedReadCaseCounts = generatedReadCaseCounts{
	...
	NativeCompareSkips: map[string]int{
		...
		"pinned Intel BID C caps the exponent magnitude before fractional-digit cancellation; this row pins the IEEE 754 exact decimal character-sequence value and flags":                                      2,
		"pinned Intel BID C counts a leading exponent zero against its seven-digit limit before fractional-digit cancellation; this row pins the IEEE 754 exact decimal character-sequence value and flags":     1,
	},
}
