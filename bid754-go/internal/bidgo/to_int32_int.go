...
// Bid64ToInt32Int is ported mechanically from Intel bid64_to_int32.c: bid64_to_int32_int.
func Bid64ToInt32Int(x uint64) (int32, uint32) {
	var res int32
	var x_sign uint64
	var x_exp uint64
...
// Bid64ToInt32Xint is ported mechanically from Intel bid64_to_int32.c: bid64_to_int32_xint.
func Bid64ToInt32Xint(x uint64) (int32, uint32) {
	var res int32
	var x_sign uint64
	var x_exp uint64
	var exp int // unbiased exponent
