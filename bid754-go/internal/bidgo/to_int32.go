...
const (
	MASK_SIGN             = MASK_SIGN64
	MASK_INF              = MASK_INF64
	MASK_NAN              = MASK_NAN64
	MASK_STEERING_BITS    = MASK_STEERING_BITS64
	MASK_BINARY_EXPONENT1 = MASK_BINARY_EXPONENT1_64
	MASK_BINARY_EXPONENT2 = MASK_BINARY_EXPONENT2_64
	MASK_BINARY_SIG1      = MASK_BINARY_SIG1_64
	MASK_BINARY_SIG2      = MASK_BINARY_SIG2_64
	MASK_BINARY_OR2       = MASK_BINARY_OR2_64
)

// Bid64ToInt32Rnint is ported mechanically from Intel bid64_to_int32.c: bid64_to_int32_rnint.
func Bid64ToInt32Rnint(x uint64) (int32, uint32) {
	var res int32
	var x_sign uint64
	var x_exp uint64
...
// Bid64ToInt32Xrnint is ported mechanically from Intel bid64_to_int32.c: bid64_to_int32_xrnint.
func Bid64ToInt32Xrnint(x uint64) (int32, uint32) {
	var res int32
	var x_sign uint64
	var x_exp uint64
	var exp int // unbiased exponent
