...
// Bid64ToInt64Rnint is ported mechanically from Intel bid64_to_int64.c: bid64_to_int64_rnint.
func Bid64ToInt64Rnint(x uint64) (int64, uint32) {
	...
	if (q + exp) < 0 { // n = +/-0.0...c(0)c(1)...c(q-1)
		...
		if C1 <= bid_midpoint64[ind] {
			res = 0x0000000000000000 // return 0
		} else if x_sign != 0 { // n < 0
			res = -1 // return -1
		} else { // n > 0
			res = 0x0000000000000001 // return +1
		}
...
// Bid64ToInt64Xrnint is ported mechanically from Intel bid64_to_int64.c: bid64_to_int64_xrnint.
...
// Bid64ToInt64Rninta is ported mechanically from Intel bid64_to_int64.c: bid64_to_int64_rninta.
...
// Bid64ToInt64Xrninta is ported mechanically from Intel bid64_to_int64.c: bid64_to_int64_xrninta.
